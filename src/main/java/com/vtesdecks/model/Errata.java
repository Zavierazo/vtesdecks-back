...
public enum Errata {
    ...
    AMULET_OF_TEMPORAL_PERCEPTION(100048, LocalDate.of(2025, 3, 17), "The card can now be played regardless of whether it is in hand or not"),
    CLIO_KISS(100359, LocalDate.of(2025, 3, 17), "At superior level, targets the Methuselah contesting the card rather than the contested card."),
    FROZEN_OBJECT(100795, LocalDate.of(2025, 3, 17), "At superior level, the damage is explicitly environmental."),
    TABRIZ_ASSEMBLY(101924, LocalDate.of(2025, 3, 17), "The blood gain is now optional."),
    CARDINAL_BENEDICTION(100294, LocalDate.of(2025, 10, 26), "Now prevents non-Sabbat vampires from casting votes and ballots (instead of affecting only Camarilla vampires)."),
    MIND_NUMB(101211, LocalDate.of(2025, 10, 26), "Now stuns the minion. Stun: lock a minion and put a stun counter on them. A minion with one or more stun counters does not unlock as normal at the beginning of their controller’s unlock phase; during that unlock phase, burn all stun counters they had at the beginning of the turn."),
    PRIVATE_AUDIENCE(101490, LocalDate.of(2025, 10, 26), "Now costs no blood (instead of 1 blood)."),
    RUTOR_HAND(101664, LocalDate.of(2025, 10, 26), "Now enters play locked and requires to lock the card to unlock."),
    WALL_STREET_NIGHT(102142, LocalDate.of(2025, 10, 26), "The card is now locked when the minion attempts the action to move counters.");
