...
public class ApiStatisticsController {
    ...
    @ResponseBody
    public ResponseEntity<ApiYearStatistic> comments(@RequestParam(name = "year") Integer year, @RequestParam(name = "type", required = false, defaultValue = "ALL") DeckType type) {
        return new ResponseEntity<>(apiStatisticsService.getYearStatistic(type, year), HttpStatus.OK);
    }

    @GetMapping(value = "/tags", produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    public ResponseEntity<List<ApiHistoricStatistic>> tags(@RequestParam(name = "type", required = false, defaultValue = "ALL") DeckType type) {
    ...
    @ResponseBody
    public ResponseEntity<List<ApiHistoricStatistic>> clans(@RequestParam(name = "type", required = false, defaultValue = "ALL") DeckType type) {
    ...
    @ResponseBody
    public ResponseEntity<List<ApiHistoricStatistic>> disciplines(@RequestParam(name = "type", required = false, defaultValue = "ALL") DeckType type) {
