...
public class ApiDeckController {
    ...
    public ResponseEntity<ApiDecks> decks(HttpServletRequest request,
        ...
        DeckQuery deckQuery = DeckQuery.builder()
                ...
                .master(new DeckQuery.CardProportion(master))
                .action(new DeckQuery.CardProportion(action))
                .political(new DeckQuery.CardProportion(political))
                .retainer(new DeckQuery.CardProportion(retainer))
                .equipment(new DeckQuery.CardProportion(equipment))
                .ally(new DeckQuery.CardProportion(ally))
                .modifier(new DeckQuery.CardProportion(modifier))
                .combat(new DeckQuery.CardProportion(combat))
                .reaction(new DeckQuery.CardProportion(reaction))
                .event(new DeckQuery.CardProportion(event))
