...
public abstract class ApiCollectionMapper {
    ...
    // Creation mapping: identity and audit fields must be generated by the server.
    @Mapping(target = "id", ignore = true)
    @Mapping(target = "creationDate", ignore = true)
    @Mapping(target = "modificationDate", ignore = true)
    @Mapping(target = "publicHash", ignore = true)
    ...
    // Creation mapping: never use a client-supplied primary key for persistence.
    @Mapping(target = "id", ignore = true)
    @Mapping(target = "creationDate", ignore = true)
    @Mapping(target = "modificationDate", ignore = true)
    @Mapping(target = "collectionId", ignore = true)
